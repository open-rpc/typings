...
// Orphaned blocks that can be included in the chain but at a lower block reward. NOTE: An
// uncle doesn’t contain individual transactions.
...
// The merkle proofs of the specified account connecting them to the blockhash of the block
// specified
